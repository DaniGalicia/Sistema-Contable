...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public void generarReporte() {
        ...
        List<CuentaSaldada> listaPariticipantes = new ArrayList<CuentaSaldada>();

        Collection hola;
        JasperReport reporte;
        try {
            reporte = (JasperReport) JRLoader.loadObject("src/SIC/Imagenes/OrdenFabricacion.jasper");

            HashMap<String, Object> parametros = new HashMap<String, Object>();
            parametros.put("orden", SICService.getServOrdenFabricacion().getByPK(OrdenFabricacion.class, BigDecimal.valueOf(29)));
